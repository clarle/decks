...
SlideDeck.prototype.loadConfig_ = function(config) {
  ...
  if (this.config_.presenters) {
    ...
    if (presenters.length == 1) {
      ...
      var linkedin = p.linkedin ? '<span>linkedin</span><a href="http://ca.linkedin.com/in/' + p.linkedin.substr(1) + '">' + p.linkedin + '</a>' : '';

      var github = p.github ? '<span>github</span><a href="https://github.com/' + p.github.substr(1) + '">' + p.github + '</a>' : '';

      var html2 = [twitter, linkedin, github].join('<br>');
